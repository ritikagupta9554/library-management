    ...
    <footer className="bg-gray-800 text-white mt-12">
      <div className="max-w-7xl mx-auto px-4 py-12">
        <div className="grid md:grid-cols-4 gap-8">
          {/* About Section */}
          <div>
            <h3 className="text-2xl font-bold mb-4 text-blue-400">Library</h3>
            <p className="text-gray-300 mb-4">
              Your gateway to knowledge and learning. Discover, explore, and grow with our extensive collection.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link to="/enquiry" className="text-gray-300 hover:text-blue-400 transition">
                  Enquiry
                </Link>
              </li>
            </ul>
          ...
          <div>
            ...
            <ul className="space-y-2 text-gray-300">
              <li className="flex items-start">
                ...
                <span>Library Road, Gorakhnath<br/>Gorakhpur, UP 273001, India</span>
              </li>
        ...
        <div className="border-t border-gray-700 mt-8 pt-8 text-center">
          <p className="text-gray-400">
            &copy; 2025 Library. All rights reserved. Made with ❤️ for book lovers.
          </p>
        </div>
      </div>
    </footer>
